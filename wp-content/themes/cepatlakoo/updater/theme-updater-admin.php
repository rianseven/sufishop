	...
	function cl_check_license() {
		...
		if ( $check['raw']->license == 'empty' ) : ?>
			<div class="notice notice-error">
				<p><strong><?php esc_html_e('Cepatlakoo License', 'cepatlakoo'); ?></strong>
				<br /> <?php echo $check['msg'] ?> <a href="<?php echo admin_url('themes.php?page=cepatlakoo-license'); ?>" class="button button-primary"><?php esc_html_e( 'Activate License', 'cepatlakoo' ); ?></a></p>
			</div>
		<?php elseif ( $check['raw']->license != 'valid' ) : ?>
			<div class="notice notice-error">
				<p><strong><?php esc_html_e('Cepatlakoo License', 'cepatlakoo'); ?></strong> <br /> <?php echo $check['msg'] ?> <a href="<?php echo admin_url('themes.php?page=cepatlakoo-license'); ?>" class="button button-primary"><?php esc_html_e( 'Activate License', 'cepatlakoo' ); ?></a></p>
			</div>
		<?php endif; 
	}
}