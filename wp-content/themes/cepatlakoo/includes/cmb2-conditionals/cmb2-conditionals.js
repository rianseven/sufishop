jQuery( document ).ready( function( $ ) {
	...
	$('input#cl_countdown_shortcode').attr('readonly', true);
	...
	function CMB2ConditionalsInit( changeContext, conditionContext ) {
		...
		changeContext.on( 'change', 'input, textarea, select', function( evt ) {
			...
			if ( 'undefined' === typeof dependants ) {
				return;
			}
	...
	if($('select[name="cepatlakoo_choose_slideshow"]').val() == 'carousel'){
		$('#slideshow_fullwidth_image_group_repeat').hide();
		$('#slideshow_carousel_image_group_repeat').show();
	}else if($('select[name="cepatlakoo_choose_slideshow"]').val() == 'fullwidth'){
		$('#slideshow_carousel_image_group_repeat').hide();
		$('#slideshow_fullwidth_image_group_repeat').show();
	}


	$('select[name="cepatlakoo_choose_slideshow"]').live('change', function() {
		if($('select[name="cepatlakoo_choose_slideshow"]').val() == 'carousel'){
			$('#slideshow_fullwidth_image_group_repeat').hide();
			$('#slideshow_carousel_image_group_repeat').show();
		}else if($('select[name="cepatlakoo_choose_slideshow"]').val() == 'fullwidth'){
	...
	if($('select[name="cl_countdown_type"]').val() == 'Normal Countdown'){
		$('#cl_countdown_detection').hide();
		$('#cl_countdown_day').hide();
		$('#cl_countdown_hour').hide();
		$('#cl_countdown_minute').hide();
		$('#cl_countdown_second').hide();
		$('.cmb2-id-cl-countdown-detection').hide();
		$('.cmb2-id-cl-countdown-day').hide();
		$('.cmb2-id-cl-countdown-hour').hide();
		$('.cmb2-id-cl-countdown-minute').hide();
		$('.cmb2-id-cl-countdown-second').hide();

		$('#cl_normal_countdown_detection').show();
		$('#cl_normal_countdown_date').show();
		$('#cl_normal_countdown_hour').show();
		$('#cl_normal_countdown_minute').show();
		$('#cl_normal_countdown_second').show();
		$('.cmb2-id-cl-normal-countdown-detection').show();
		$('.cmb2-id-cl-normal-countdown-date').show();
		$('.cmb2-id-cl-normal-countdown-hour').show();
		$('.cmb2-id-cl-normal-countdown-minute').show();
		$('.cmb2-id-cl-normal-countdown-second').show();
	}else if($('select[name="cl_countdown_type"]').val() == 'Evergreen Countdown'){
		$('#cl_normal_countdown_detection').hide();
		$('#cl_normal_countdown_date').hide();
		$('#cl_normal_countdown_hour').hide();
		$('#cl_normal_countdown_minute').hide();
		$('#cl_normal_countdown_second').hide();
		$('.cmb2-id-cl-normal-countdown-detection').hide();
		$('.cmb2-id-cl-normal-countdown-date').hide();
		$('.cmb2-id-cl-normal-countdown-hour').hide();
		$('.cmb2-id-cl-normal-countdown-minute').hide();
		$('.cmb2-id-cl-normal-countdown-second').hide();

		$('#cl_countdown_detection').show();
		$('#cl_countdown_day').show();
		$('#cl_countdown_hour').show();
		$('#cl_countdown_minute').show();
		$('#cl_countdown_second').show();
		$('.cmb2-id-cl-countdown-detection').show();
		$('.cmb2-id-cl-countdown-date').show();
		$('.cmb2-id-cl-countdown-hour').show();
		$('.cmb2-id-cl-countdown-minute').show();
		$('.cmb2-id-cl-countdown-second').show();
	}

	$('select[name="cl_countdown_type"]').live('change', function() {
		if($('select[name="cl_countdown_type"]').val() == 'Normal Countdown'){
			$('#cl_countdown_detection').hide();
			$('#cl_countdown_day').hide();
			$('#cl_countdown_hour').hide();
