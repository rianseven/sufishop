...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form" style="display:none;">
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_city', true ) ) : ?>
			...
			<p class="form-row form-row-wide" id="calc_shipping_city_field"><span>
				<select name="calc_shipping_city" id="calc_shipping_city" class="calc_shipping_city city_select" rel="calc_shipping_city">
					<option value=""><?php esc_html_e( 'Select a province first&hellip;', 'woocommerce' ); ?></option>
				</select></span>
			</p>
